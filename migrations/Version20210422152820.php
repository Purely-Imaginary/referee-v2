 ...
 */
final class Version20210422152820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, wins INT NOT NULL, losses INT NOT NULL, goals_shot INT NOT NULL, goals_scored INT NOT NULL, goals_lost INT NOT NULL, win_rate DOUBLE PRECISION NOT NULL, rating DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE player_snapshot (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, team_id INT DEFAULT NULL, calculated_match_id INT DEFAULT NULL, team_snapshot_id INT DEFAULT NULL, rating DOUBLE PRECISION NOT NULL, is_red TINYINT(1) NOT NULL, INDEX IDX_2A9A54D599E6F5DF (player_id), INDEX IDX_2A9A54D5296CD8AE (team_id), INDEX IDX_2A9A54D5901D0D7A (calculated_match_id), INDEX IDX_2A9A54D59009D613 (team_snapshot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE team_snapshot (id INT AUTO_INCREMENT NOT NULL, red_calculated_match_id INT DEFAULT NULL, avg_team_rating DOUBLE PRECISION NOT NULL, score INT NOT NULL, rating_change DOUBLE PRECISION NOT NULL, INDEX IDX_940FC94B257F118 (red_calculated_match_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE player_snapshot ADD CONSTRAINT FK_2A9A54D5901D0D7A FOREIGN KEY (calculated_match_id) REFERENCES `calculated_match` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player_snapshot DROP FOREIGN KEY FK_2A9A54D5901D0D7A');
